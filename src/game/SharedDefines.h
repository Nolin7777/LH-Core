...
enum SpellEffects
{
    ...
    SPELL_EFFECT_APPLY_AREA_AURA_OWNER     = 143, // NOSTALRIUS 133
    ...
    // Custom Nostalrius
    SPELL_EFFECT_DESPAWN_OBJECT            = 154, // 130
    SPELL_EFFECT_NOSTALRIUS                = 155, // 131
    SPELL_EFFECT_APPLY_AREA_AURA_RAID      = 156, // 132
    TOTAL_SPELL_EFFECTS                    = 157
};
